...
Set RS=Server.CreateObject("Adodb.recordset")
	SQL = "SELECT * FROM imprensa WHERE imprensa_id LIKE '" & Id & "';"
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("imprensa_nome") %>" /></td>
            </tr>
			<tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            ...
            <tr>
              ...
              <td id="fotoCel">
<%
If fso.fileExists(Server.MapPath("../../imagens/imprensa/" & Id & ".jpg")) = True Then

	Set arquivo = FSO.GetFolder(Server.MapPath("../../imagens/imprensa/")).files.item(Id & ".jpg")
				
		zoomImg = "../../imagens/imprensa/" & Id & ".jpg"
...
<div id="hideEdit"><textarea name="editBox"><%= RS("imprensa_desc") %></textarea></div>
</form>
</body>
</html>
<%
