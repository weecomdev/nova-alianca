...
Set RS=Server.CreateObject("Adodb.recordset")
	SQL = "SELECT * FROM home WHERE home_id LIKE '" & Id & "';"
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("home_nome") %>" maxlength="30" /></td>
            </tr>
			<tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
                ...
                <td><input name="descricao" type="text" class="inputEditar" value="<%= RS("home_desc") %>" maxlength="255" /></td>
            </tr>
            <tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
              ...
              <td id="fotoCel">
<%
If fso.fileExists(Server.MapPath("../../imagens/home/" & Id & ".jpg")) = True Then

	Set arquivo = FSO.GetFolder(Server.MapPath("../../imagens/home/")).files.item(Id & ".jpg")
				
		zoomImg = "../../imagens/home/" & Id & ".jpg"
