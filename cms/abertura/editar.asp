...
Set RS=Server.CreateObject("Adodb.recordset")
	SQL = "SELECT * FROM abertura WHERE abertura_id LIKE '" & Id & "';"
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("abertura_nome") %>" maxlength="30" /></td>
            </tr>
			<tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
                ...
                <td><input name="descricao" type="text" class="inputEditar" value="<%= RS("abertura_desc") %>" maxlength="255" /></td>
            </tr>
            <tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
              ...
              <td id="fotoCel">
<%
If fso.fileExists(Server.MapPath("../../imagens/abertura/" & Id & ".jpg")) = True Then

	Set arquivo = FSO.GetFolder(Server.MapPath("../../imagens/abertura/")).files.item(Id & ".jpg")
				
		zoomImg = "../../imagens/abertura/" & Id & ".jpg"
