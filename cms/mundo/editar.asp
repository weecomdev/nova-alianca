...
Set RS=Server.CreateObject("Adodb.recordset")
	SQL = "SELECT * FROM mundo WHERE mundo_id LIKE '" & Id & "';"
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("mundo_nome") %>" /></td>
            </tr>
			<tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
                ...
                <td><textarea name="descricao" class="inputEditar" style="height: 100px;"><%= RS("mundo_desc") %></textarea></td>
            </tr>
            <tr>
                <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
