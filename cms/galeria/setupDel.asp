...
Set fso = CreateObject("Scripting.FileSystemObject")
	...
	For x = 1 to CInt(numFotos)
		If Request.Form("box_" & x) <> "" Then
			fso.DeleteFile Server.MapPath("../../imagens/galeria/" & Id & "/fotos/" & Id & "_" & x & ".jpg")
			fso.DeleteFile Server.MapPath("../../imagens/galeria/" & Id & "/thumbs/" & Id & "_" & x & ".jpg")
		End If
	Next

	'Processo de renomear arquivos
	Set folder = fso.GetFolder(Server.Mappath("../../imagens/galeria/" & Id & "/thumbs/"))
		Set files = folder.Files
			...
			If afterNum > 0 Then
				...
				For Each File in Files
					...
					'renomear imagens				
					fso.MoveFile Server.MapPath("../../imagens/galeria/" & Id & "/fotos/" & File.Name), _
								 Server.MapPath("../../imagens/galeria/" & Id & "/fotos/" & preZero & nomeFinal & ".jpg")
					'renomear miniaturas
					fso.MoveFile Server.MapPath("../../imagens/galeria/" & Id & "/thumbs/" & File.Name), _
								 Server.MapPath("../../imagens/galeria/" & Id & "/thumbs/" & preZero & nomeFinal & ".jpg")
				...
				For Each File in Files
					...
					If numNew <= afterNum Then
						'renomar imagens
						fso.MoveFile Server.MapPath("../../imagens/galeria/" & Id & "/fotos/" & File.Name), _
									 Server.MapPath("../../imagens/galeria/" & Id & "/fotos/" & Id & "_" & numNew & ".jpg")
						'renomear miniaturas
						fso.MoveFile Server.MapPath("../../imagens/galeria/" & Id & "/thumbs/" & File.Name), _
									 Server.MapPath("../../imagens/galeria/" & Id & "/thumbs/" & Id & "_" & numNew & ".jpg")
