...
<body>
<form name="form" action="upAlterar.asp" method="post" enctype="multipart/form-data" onSubmit="return validateForm(this);">
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("video_home_nome") %>" maxlength="255" /></td>
            </tr>
            <tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
              ...
              <td><input name="descricao" type="text" class="inputEditar" value="<%= RS("video_home_desc") %>" maxlength="255" /></td>
            </tr>
            <tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            <tr>
              ...
              <td id="fotoCel">
<%
If fso.fileExists(Server.MapPath("../../imagens/geral/video.jpg")) = True Then

	Set arquivo = FSO.GetFolder(Server.MapPath("../../imagens/geral/")).files.item("video.jpg")
				
		zoomImg = "../../imagens/geral/video.jpg"
