...
Set RS=Server.CreateObject("Adodb.recordset")
	SQL = "SELECT * FROM agenda WHERE agenda_id LIKE '" & Id & "';"
...
<table id="tableForm" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="nome" type="text" class="inputEditar" value="<%= RS("agenda_nome") %>" /></td>
            </tr>
			<tr>
              <td colspan="2"><img src="../interface/layout_pixel.gif" id="spacer"></td>
            </tr>
            ...
            <tr>
              ...
              <td id="fotoCel">
<%
If fso.fileExists(Server.MapPath("../../imagens/agenda/" & Id & ".jpg")) = True Then

	Set arquivo = FSO.GetFolder(Server.MapPath("../../imagens/agenda/")).files.item(Id & ".jpg")
				
		zoomImg = "../../imagens/agenda/" & Id & ".jpg"
...
<div id="hideEdit"><textarea name="editBox"><%= RS("agenda_desc") %></textarea></div>
</form>
</body>
</html>
<%
