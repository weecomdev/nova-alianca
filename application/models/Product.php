        ...
        if(!empty($alias)){
            ...
            if ($this->uri->segment('1') != 'gerenciador'){
                ...
                if($this->session->userdata('lang')=='es'){
                    $this->db->select('P.name_es as name');
                    $this->db->select('P.type_es as type');
                    $this->db->select('P.description_es as description');
                    $this->db->select('P.frase_p1_es as frase_p1');
                    $this->db->select('P.frase_p2_es as frase_p2');
                    $this->db->select('P.frase_p3_es as frase_p3');
                }
            }
