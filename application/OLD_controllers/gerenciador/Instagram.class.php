...
class Instagram {
   ...
   * @return mixed
   */
  public function getTagMediaMin($name, $next_min_id=null) {
        if(isset($next_min_id)){
            return $this->_makeCall('tags/' . $name . '/media/recent', false, array('min_tag_id' => $next_min_id));
        } else {
            return $this->_makeCall('tags/' . $name . '/media/recent');
        }
  }
