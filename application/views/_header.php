...
fbq('init', '1121281871975458');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1121281871975458&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
    ...
    <meta name="facebook-domain-verification" content="x0xz4jyiz5v0aae2dygo8rny2gav4t" />
    <link rel="stylesheet" type="text/css" href="<?php echo site_url('_assets/css/main.min.css') ?>?d=7" />
    <link rel="stylesheet" type="text/css" href="<?php echo site_url('_assets/css/custom.css') ?>?d=7" />
...
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= 'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f); })(window,document,'script','dataLayer','GTM-MZMQN28');</script>
<!-- End Google Tag Manager -->
</head>

<body>
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MZMQN28" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="contact_box">
            ...
            <ul class="box">
                ...
                <li>
                    <ul>
                        <li class="a">
                            <a href="https://www.linkedin.com/company/cooperativa-nova-alian%C3%A7a/" target="_blank">
                                <div class="text">
    ...
    <header id="header">
        <div class="mobile_menu mobile block">
            <a href="<?php echo site_url(); ?>"><img src="<?php echo site_url(TEXT_IMAGES_PATH . $this->Text->getText('main_logo', false, true)) ?>" alt="Nova Aliança"></a>

            <a href="http://loja.vinicolaalianca.com.br" class="btn btn-online" target="_blank" style="margin-top:15px;">Comprar on-line</a>
        ...
        <div class="menu container responsive fixed">
            <div class="left">
                <a href="<?php echo site_url(); ?>"><img src="<?php echo site_url(TEXT_IMAGES_PATH . $this->Text->getText('main_logo', false, true)) ?>" alt=""></a>
            </div>
            <div class="mid item">
                <a href="http://loja.vinicolaalianca.com.br" class="btn btn-online" target="_blank">Comprar on-line</a>
            </div>
            <div class="right">
                <ul>
                    <?php
