...
<?php echo form_open_multipart('gerenciador/noticias/save', array('class'=>'form-horizontal', 'role'=>'form'));?>
	<fieldset>
      ...
      <div class="form-group">
        <label class="col-sm-1 control-label" for="subtitulo">Linha de Apoio:</label>
        <div class="col-xs-3">
        ...
        <label class="col-sm-1 control-label" for="subtitulo_es">ES:</label>
        <div class="col-xs-3">
             <textarea name="subtitulo_es" class="form-control" id="subtitulo_es" rows="10"><?php echo empty($item->subtitulo_es) ? set_value('subtitulo_es') : $item->subtitulo_es?></textarea>
        </div>
      </div>
    	<div class="form-group">
