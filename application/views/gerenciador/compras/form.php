...
<div class="page-header">
    <ol class="breadcrumb">
    	...
    	<li class="active"><?php echo empty($item->compra_id) ? 'Adicionar' : 'Editar' ?></li>
    </ol>
</div>

<?php echo form_open_multipart('gerenciador/compras/save', array('class'=>'form-horizontal', 'role'=>'form'));?>
	<fieldset>
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<input type="hidden" name="compra_id" value="<?php echo empty($item->compra_id) ? '' : $item->compra_id; ?>" />
				<button class="btn btn-primary" type="submit">Salvar</button>
				<a href="<?php echo site_url('gerenciador/compras')?>" class="btn btn-default">Voltar</a>
			</div>
		</div>
    </fieldset>
<?php echo form_close();?>
