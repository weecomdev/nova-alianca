...
<?php echo form_open_multipart('gerenciador/products/save',array('class'=>'form-horizontal'));?>
	<fieldset>
        ...
        <div class="form-group">
            ...
            <label class="col-sm-1 control-label" for="type_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="type_es" class="form-control" id="type_es" value="<?php echo empty($item->type_es) ? set_value('type_es') : $item->type_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="options">Opções (separadas por vírgula):</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="description_es">Descrição ES:</label>
            <div class="col-xs-8">
                <textarea name="description_es" id="description_es" cols="30" rows="10"><?php echo empty($item->description_es) ? set_value('description_es') : $item->description_es?></textarea><?php echo display_ckeditor($ck3); ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="frase_p1">Frase P1:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="frase_p1_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="frase_p1_es" class="form-control" id="frase_p1_es" value="<?php echo empty($item->frase_p1_es) ? set_value('frase_p1_es') : $item->frase_p1_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="frase_p2">Frase P2:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="frase_p2_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="frase_p2_es" class="form-control" id="frase_p2_es" value="<?php echo empty($item->frase_p2_es) ? set_value('frase_p2_es') : $item->frase_p2_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="frase_p3">Frase P3:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="frase_p3_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="frase_p3_es" class="form-control" id="frase_p3_es" value="<?php echo empty($item->frase_p3_es) ? set_value('frase_p3_es') : $item->frase_p3_es?>" />
            </div>
        </div>
