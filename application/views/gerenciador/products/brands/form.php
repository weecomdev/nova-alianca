...
<?php echo form_open_multipart('gerenciador/products_brands/save',array('class'=>'form-horizontal', 'role'=>'form'));?>
	<fieldset>
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="description">Descrição:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="description_es">ES:</label>
            <div class="col-xs-3">
                 <textarea name="description_es" class="form-control" id="description_es"><?php echo empty($item->description_es) ? set_value('description_es') : $item->description_es ?></textarea>
            </div>
        </div>
        <div class="form-group">
