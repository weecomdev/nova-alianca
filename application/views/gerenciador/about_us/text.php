...
<?php echo form_open('gerenciador/about_us_text/save',array('class'=>'form-horizontal', 'role'=>'form'));?>
	<fieldset>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_frase_p1">Frase Banner P1:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_frase_p1_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="inst_frase_p1_es" class="form-control" id="inst_frase_p1_es" value="<?php echo empty($inst_frase_p1_es) ? set_value('inst_frase_p1_es') : $inst_frase_p1_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_frase_p2">Frase Banner P2:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_frase_p2_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="inst_frase_p2_es" class="form-control" id="inst_frase_p2_es" value="<?php echo empty($inst_frase_p2_es) ? set_value('inst_frase_p2_es') : $inst_frase_p2_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_frase_p3">Frase Banner P3:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_frase_p3_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="inst_frase_p3_es" class="form-control" id="inst_frase_p3_es" value="<?php echo empty($inst_frase_p3_es) ? set_value('inst_frase_p3_es') : $inst_frase_p3_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_title11">Titulo 1 P1:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_title11_es">ES:</label>
            <div class="col-xs-3">
                 <input type="text" name="inst_title11_es" class="form-control" id="inst_title11_es" value="<?php echo empty($inst_title11_es) ? set_value('inst_title11_es') : $inst_title11_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_title12">Titulo 1 P2:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_title12_es">ES:</label>
            <div class="col-xs-3">
                <input type="text" name="inst_title12_es" class="form-control" id="inst_title12_es" value="<?php echo empty($inst_title12_es) ? set_value('inst_title12_es') : $inst_title12_es?>" />
            </div>
        </div>
    	<div class="form-group">
   			<label class="col-sm-1 control-label" for="inst_text1">Texto 1:</label>
   			<div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_text1_en">Texto 1 EN:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_text1_es">Texto 1 ES:</label>
            <div class="col-xs-11">
                <textarea name="inst_text1_es"  id="inst_text1_es"><?php echo empty($inst_text1_es) ? set_value('inst_text1_es') : $inst_text1_es?></textarea>
          <?php echo display_ckeditor($ck1_es); ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_title21">Titulo 2 P1:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_title21_es">ES:</label>
            <div class="col-xs-3">
                <input type="text" name="inst_title21_es" class="form-control" id="inst_title21_es" value="<?php echo empty($inst_title21_es) ? set_value('inst_title21_es') : $inst_title21_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_title22">Titulo 2 P2:</label>
            <div class="col-xs-3">
            ...
            <label class="col-sm-1 control-label" for="inst_title22_es">ES:</label>
            <div class="col-xs-3">
                <input type="text" name="inst_title22_es" class="form-control" id="inst_title22_es" value="<?php echo empty($inst_title22_es) ? set_value('inst_title22_es') : $inst_title22_es?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_text2">Texto 2:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_text2_en">Texto 2 EN:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_text2_es">Texto 2 ES:</label>
            <div class="col-xs-11">
                <textarea name="inst_text2_es"  id="inst_text2_es"><?php echo empty($inst_text2_es) ? set_value('inst_text2_es') : $inst_text2_es?></textarea>
          <?php echo display_ckeditor($ck2_es); ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_valores">Valores:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_valores_en">Valores EN:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_valores_es">Valores ES:</label>
            <div class="col-xs-11">
                <textarea name="inst_valores_es"  id="inst_valores_es"><?php echo empty($inst_valores_es) ? set_value('inst_valores_es') : $inst_valores_es?></textarea>
          <?php echo display_ckeditor($ck3_es); ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_principios">Princípios:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_principios_en">Princípios EN:</label>
            <div class="col-xs-11">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label" for="inst_principios_es">Princípios ES:</label>
            <div class="col-xs-11">
                <textarea name="inst_principios_es"  id="inst_principios_es"><?php echo empty($inst_principios_es) ? set_value('inst_principios_es') : $inst_principios_es?></textarea>
          <?php echo display_ckeditor($ck4_es); ?>
            </div>
        </div>
		<div class="form-group">
