...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li> <a href="<?php echo site_url('gerenciador/dicas_imagens/index').'/'.$id;?>">Imagens</a> </li>
	    <li class="active">Adicionar Imagens</li>
    </ol>
</div>
<br />
<form id="fileupload" action="<?php echo site_url('index.php/gerenciador/dicas_imagens/upload/').'/'.$id;?>" method="POST" enctype="multipart/form-data">
 <input type="hidden" name="product_id" value="<?php echo $id;?>">
    <div class="row fileupload-buttonbar">
        <div class="col-sm-10">        
            ...
            <a href="<?php echo site_url('gerenciador/dicas_imagens/index').'/'.$id;?>" class="btn btn-default">Voltar</a>
        </div>
