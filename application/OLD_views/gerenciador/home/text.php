...
<?php echo form_open('gerenciador/home/save',array('class'=>'form-horizontal', 'role'=>'form'));?>
	<fieldset>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home1_frase_p1">Frase P1:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home1_frase_p2">Frase P2:</label>
            <div class="col-xs-4">
    	...
    	<div class="form-group">
   			<label class="col-sm-2 control-label" for="home1_text">Texto:</label>
   			<div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home1_link_title">Link Title:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home1_link">Link:</label>
            <div class="col-xs-4">
        ...
        <h3>Link 2</h3>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home2_frase_p1">Frase P1:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home2_frase_p2">Frase P2:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home2_text">Texto:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home2_link_title">Link Title:</label>
            <div class="col-xs-4">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="home2_link">Link:</label>
            <div class="col-xs-4">
