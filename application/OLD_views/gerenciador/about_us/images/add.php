...
<div class="page-header">
    <ol class="breadcrumb">
	    <li>Institucional</li>
        <li> <a href="<?php echo site_url('gerenciador/about_us_images');?>">Imagens</a> </li>
	    <li class="active">Adicionar Imagens</li>
    </ol>
</div>
<br />
<form id="fileupload" action="<?php echo site_url('index.php/gerenciador/about_us_images/upload/');?>" method="POST" enctype="multipart/form-data">
    <div class="row fileupload-buttonbar">
        <div class="col-sm-10">        
            ...
            <a href="<?php echo site_url('gerenciador/about_us_images');?>" class="btn btn-default">Voltar</a>
        </div>
