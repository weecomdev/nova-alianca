...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {
		...
		// $return = '<script src="//cdn.ckeditor.com/4.4.7/standard/ckeditor.js"></script>';
...
function display_ckeditor($data = array())
{
    ...
    // helper
    $return .= '<a href="'.site_url('gerenciador/texts/ajuda_editor').'" class="various fancybox.iframe">Precisa de ajuda?</a>';
