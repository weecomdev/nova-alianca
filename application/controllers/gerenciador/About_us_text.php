...
class About_Us_Text extends MY_Controller {
	...
	public function index()
	{
     ...
     $this->data['ck1_en'] = array('id' => 'inst_text1_en', 'path' => '_assets/js/ckeditor');
       ...
       $this->data['ck2_es'] = array('id' => 'inst_text2_es', 'path' => '_assets/js/ckeditor');
       $this->data['inst_valores'] = $this->Text->getText('inst_valores');
       $this->data['inst_valores_en'] = $this->Text->getTextEn('inst_valores');
       $this->data['inst_valores_es'] = $this->Text->getTextEs('inst_valores');
       ...
       $this->data['ck3_es'] = array('id' => 'inst_valores_es', 'path' => '_assets/js/ckeditor');
       ...
       $this->data['inst_principios_es'] = $this->Text->getTextEs('inst_principios');
       ...
       $this->data['ck4_es'] = array('id' => 'inst_principios_es', 'path' => '_assets/js/ckeditor');
