...
class Banners extends MY_Controller {
    ...
    public function save(){
        ...
        else
        {
            ...
            $upload_data['img_es'] = $this->do_upload('img_es', BANNERS_UPLOAD_PATH);
            ...
            if(!empty($upload_data['img_es']['file'])){
                $this->image_moo->load($base_dir . $upload_data['img_es']['file'])->resize(700, 700)->save($base_dir . $upload_data['img_es']['file'],true);
            }
