...
class Noticias extends MY_Controller {
    ...
    public function detalhes($slug)
    {
        ...
        $img = $this->MNoticia_imagem->getAll($noticia->noticia_id);
        $this->data['page_img'] = site_url(NOTICIAS_IMAGES_PATH.$img[0]->thumb_image);
        $this->data['page_title'] = $noticia->titulo;
        $this->data['page_desc'] = $noticia->texto;
        $this->load->view('noticias', $this->data);
    }
