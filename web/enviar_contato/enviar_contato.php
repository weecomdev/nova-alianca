...
//	$testabd = 1;
	...
	$sys_db_server 		= "localhost"; 	// Host
	$sys_db_user 		= "simplesa_testehm"; 					// User
	$sys_db_pass 		= "9,vhK(a~_oW9";							// Pass
	$sys_db_database	= "simplesa_novaalianca03";					// BcoDados
...
try {
	$mail->Host       	= "hl-60us.hostmidia.com.br";	// SMTP server
	$mail->SMTPDebug  	= 0;                     	// enables SMTP debug information (for testing) (usar "2" para teste)
	$mail->SMTPAuth   	= true;                  	// enable SMTP authentication
	$mail->Host       	= "hl-60us.hostmidia.com.br";	// sets the SMTP server
	$mail->Port       	= 587;                    	// set the SMTP port for the GMAIL server
	$mail->Username   	= "testehm";			// SMTP account username
	$mail->Password   	= "s&_Ii?C}#gmA";					// SMTP account password

	$mail->Charset		= 'utf-8';
	$mail->AddAddress	($mailer_para_email, $mailer_para_nome);
	$mail->AddReplyTo	($mailer_de_email, $mailer_de_nome);
	$mail->SetFrom		('testehm@novaalianca.coop.br', $tipo_contato.' - Site novaalianca.coop.br/contato');
