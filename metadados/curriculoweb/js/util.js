 ...
 * 
 * Licenciado sob os termos da licença Creative Commons, Atribuição -
 * Compartilhamento pela mesma licença 2.5:
 * http://creativecommons.org/licenses/by-sa/2.5/br/ Qualquer outra forma de uso
 * requer autorização expressa do autor.
 * 
...
/**
 * Elimina caracteres de formatação e zeros à esquerda da string de número
 * fornecida.
 * 
 * @param String
 *            pNum String de número fornecida para ser desformatada.
 ...
 *            /).
 * @param boolean
 *            pIsCnpj Indica se a string fornecida é um CNPJ. Caso contrário, é
 *            CPF. Default = false (CPF).
 ...
 * 
 * @param String
 *            pEfetivo String do número-efetivo (SEM dígitos verificadores) de
 *            CNPJ ou CPF.
 * @param boolean
 *            pIsCnpj Indica se a string fornecida é de um CNPJ. Caso contrário,
 ...
 * 
 * @param String
 *            pCpf String fornecida para ser testada.
 ...
 * 
 * @param String
 *            pCnpj String fornecida para ser testada.
...
function isCnpj(pCnpj) {
	...
	if (ordem == "0000")
		return false;
	return (base == "00000000" || parseInt(ordem, 10) <= 300 || base.substring(
			0, 3) != "000");
} //isCnpj

/**
 * Testa se a String pCpfCnpj fornecida é um CPF ou CNPJ válido. Se a String
 * tiver uma quantidade de dígitos igual ou inferior a 11, valida como CPF. Se
 * for maior que 11, valida como CNPJ. Qualquer formatação que não seja
 * algarismos é desconsiderada.
 * 
 * @param String
 *            pCpfCnpj String fornecida para ser testada.
